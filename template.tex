...
\begin{document}
\date{}
\title{Real-time Ground Stereo-Vision-in-Loop Localization System for Safe Landing of Fixed-wing UAVs}
...
\begin{table*}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ccccccc}
			...
			\multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}\textbf{Small-sized}\\ \textbf{UAV}\end{tabular}} & 1                         & 355                     & 6.31 / 9.51  & 14.39 / 15.35 & \textbf{6.14} / 21.13 & 6.20 / \textbf{21.22}                                                         \\
			...
			\multirow{3}{*}{\begin{tabular}[c]{@{}c@{}}\textbf{Middle-sized}\\ \textbf{UAV} \end{tabular}} & 1                         & 137                     & 8.01 / 8.33  & 11.41 / 13.33 & 7.85 / \textbf{17.00} & \textbf{5.99} / 16.10                                                         \\
...
\begin{table}[]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ccccc|cc}
			...
			\multicolumn{1}{l}{} & \textbf{Mean Shift} & \textbf{AdaBoost} & \textbf{Chan-Vase} & \textbf{Saliency-inspired} & \textbf{SRC-TLD} & \textbf{SRC-TLD + BBS} \\ \hline
			\textbf{RMSE X (m)} & 0.578 & 0.457 & 0.271 & 0.770 & 0.542 & \textbf{0.251} \\
			\textbf{RMSE Y (m)} & 5.241 & 2.421 & 1.811 & 1.763 & 1.437 & \textbf{1.314} \\
			\textbf{RMSE Z (m)} & 0.823 & 0.547 & 0.314 & 0.508 & 0.348 & \textbf{0.212} \\
			\hline
