...
\title{A Separate Stereo Vision Guidance System for Autonomous Landing of a UAV}
...
Also, we compared SRC-TLD with Meanshift, AdaBoost and 
\begin{table*}[]
	\centering
